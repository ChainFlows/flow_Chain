...
const dummyQuotation = {
  ...
  description:
    "Next-day delivery service including packaging and handling for electronic equipment. Insurance coverage included for the full value of the items.",
  shippingCost: 1250.0,
  orderId: "ORD-001",
...
export default function ClientOrdersTable({ orders, save, save2 }) {
  const [activeTab, setActiveTab] = useState<"New" | "current" | "completed">(
    "New"
  );
  ...
  const filteredOrders = orders_.filter(
