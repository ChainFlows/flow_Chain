...
export default function ClientDashboard({ client }) {
  ...
  const datas = { id, name, logo, role: "Client" };
  ...
  const recentDrivers = [
    ...
    {
      name: "Sam Smith",
      email: "contact@samsmith.com",
      avatar: "/avatars/sam.jpg",
    },
    {
      name: "Daniel Johnson",
      email: "contact@danieljohnson.com",
      avatar: "/avatars/daniel.jpg",
    },
    {
      name: "Frances Willem",
      email: "contact@franceswillem.com",
      avatar: "/avatars/frances.jpg",
    },
  ];
              ...
              <div className="relative w-48 h-48">
                <svg className="w-full h-full transform -rotate-90">
                  {driversData.status.map((status, index) => {
                    const total = driversData.status.reduce(
